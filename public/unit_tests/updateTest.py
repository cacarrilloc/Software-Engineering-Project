#-------------------------------------------------------------------------------
# Name:        Unit Test - Test user update information.
...
WebDriverWait(driver,30).until(EC.visibility_of_element_located((By.XPATH, '//a[@href="#updateUser"]')))
driver.find_element_by_css_selector('#update').click()


#fill form
WebDriverWait(driver,30).until(EC.visibility_of_element_located((By.XPATH, '//input[@id="username"]')))
element = driver.find_element_by_id("username")
element.send_keys("testacct")
element = driver.find_element_by_id("password")
element.send_keys("wrongpassword")
element = driver.find_element_by_id("userSsn")
...
#correct log in
driver.find_element_by_id("continueButton").click()
WebDriverWait(driver,30).until(EC.visibility_of_element_located((By.XPATH, '//input[@id="continueButton"]')))
